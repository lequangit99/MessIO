...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void UpdateSettings() {
        ...
        if (TextUtils.isEmpty(setUserName)){
            Toast.makeText(this, "vui lòng nhập tên trước", Toast.LENGTH_SHORT).show();
        }
            ...
            RootRef.child("Users").child(currentUserID).setValue(profileMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                   if (task.isSuccessful()){
                       ...
                       Toast.makeText(SettingsActivity.this, "Cập nhập thông tin thành công!", Toast.LENGTH_SHORT).show();
                   }
                   else {
        ...
        RootRef.child("Users").child(currentUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if ((dataSnapshot.exists()) && dataSnapshot.hasChild("name") && dataSnapshot.hasChild("image")){
                    ...
                    Toast.makeText(SettingsActivity.this, "Cập nhật đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                }
            }
